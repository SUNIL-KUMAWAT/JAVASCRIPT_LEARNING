...
allProduct.setAttribute("value", "All Product");
let productOption = document.createElement("option");
productOption.setAttribute("value", "product");
productOption.textContent = "All Product";
allProduct.appendChild(productOption);
...
let headingPara = document.createElement("h1");
headingPara.textContent = "Apple Iphone 11 Pro Max";
var similaritemsDivhead = document.createElement('div'),
    similarhead = document.createElement('div'),
    galleryhead = document.createElement('div'),
    descriptionhead = document.createElement('div'),
    smallTexthead = document.createElement('small'),
    locationSvghead = document.createElement('img'),
    viewSvghead = document.createElement('img');
...
smallTexthead.setAttribute('id', 'fade1');
...
var imageGellery = [{ phone:'iphone1.jpg', price:1000,phoneVersion:11, view:1000},
    {phone:'iphone2.jpg', price:1010, phoneVersion:12, view:2000},
    {phone:'iphone3.jpg', price:800, phoneVersion:13, view:1520},
    {phone:'iphone4.jpg', price:1200, phoneVersion:14, view:2242},
    {phone:'iphone5.jpg', price:1199, phoneVersion:10, view:242},
    {phone:'iphone6.jpg', price:1099, phoneVersion:9, view:885},
    {phone:'iphone7.jpg', price:1599, phoneVersion:8, view:5422},
    {phone:'iphone8.jpg', price:1111, phoneVersion:7, view:2424},
    {phone:'iphone.jpg', price:1399,phoneVersion:11, view:122},
    {phone:'gray.jpg', price:2199, phoneVersion:12, view:105358},
    {phone:'green.jpg', price:2299, phoneVersion:11, view:1112},
    {phone:'red.jpg', price:3399, phoneVersion:11, view:1036},
...
imageGellery.forEach(function (element) {
    ...
    smallText.setAttribute('id', 'fade');
    smallText1.setAttribute('id', 'fade11');
    similar.classList.add('similar');
    similaritemsDiv.classList.add('padd');
    gallery.classList.add('gallery');
    similarImg.classList.add('imga');
...
let onlineshopinglist = ['Electronics','Vacancies','Real State','Vehicles','Other Services','Free Stuffs'];
...
let useFullLink = ['Home','About Us','term and Condition','FAQ','Shipping and Returns','Contact Us','privacy policies'];
