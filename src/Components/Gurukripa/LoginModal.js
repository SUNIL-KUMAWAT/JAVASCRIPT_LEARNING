...
const LoginModal = () => {
    ...
    const login = (e) => {
        e.preventDefault()
        return axios
          .post('http://192.168.1.6:4001/auth/login', {
            username,
            password,
          })
          .then((response) => {
                    ...
                    <ModalBody>
                     <form onSubmit={login}>
                        <FormControl isRequired>
                            ...
                            <Input onChange={(e) => setUserName(e.target.value) } placeholder='Registration Number'/>
                        </FormControl>
                        ...
                        {/* <FormControl isRequired>
                          ...
                          <FormControl isRequired>
                            ...
                            <InputGroup size='md'>
                                <Input onChange={(e) => setPassword(e.target.value)} pr='4.5rem'
                                    type={
                                        show ? 'text' : 'password'
                                    }
